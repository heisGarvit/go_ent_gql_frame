...
type RoleEdges struct {
	...
	namedPermissions map[string][]*RolePermission
}

// CompanyOrErr returns the Company value or an error if the edge
// was not loaded in eager-loading, or loaded but was not found.
func (e RoleEdges) CompanyOrErr() (*Company, error) {
	if e.Company != nil {
...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case role.FieldID, role.FieldCompanyID:
...
// QueryCompany queries the "company" edge of the Role entity.
func (r *Role) QueryCompany() *CompanyQuery {
	return NewRoleClient(r.config).QueryCompany(r)
}
...
func (r *Role) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", r.CompanyID))
	builder.WriteString(", ")
...
func (r *Role) NamedPermissions(name string) ([]*RolePermission, error) {
...
func (r *Role) appendNamedPermissions(name string, edges ...*RolePermission) {
	if r.Edges.namedPermissions == nil {
		r.Edges.namedPermissions = make(map[string][]*RolePermission)
	}
	if len(edges) == 0 {
		r.Edges.namedPermissions[name] = []*RolePermission{}
	} else {
