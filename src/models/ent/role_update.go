...
func (ru *RoleUpdate) SetCompanyID(u uuid.UUID) *RoleUpdate {
	ru.mutation.SetCompanyID(u)
	return ru
}

// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (ru *RoleUpdate) SetNillableCompanyID(u *uuid.UUID) *RoleUpdate {
	if u != nil {
		ru.SetCompanyID(*u)
	}
	return ru
...
func (ru *RoleUpdate) ClearCompanyID() *RoleUpdate {
	ru.mutation.ClearCompanyID()
	return ru
}
...
func (ru *RoleUpdate) SetCompany(c *Company) *RoleUpdate {
...
func (ru *RoleUpdate) ClearCompany() *RoleUpdate {
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if ru.mutation.CompanyCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   role.CompanyTable,
			Columns: []string{role.CompanyColumn},
			Bidi:    false,
...
// SetCompanyID sets the "company_id" field.
func (ruo *RoleUpdateOne) SetCompanyID(u uuid.UUID) *RoleUpdateOne {
	ruo.mutation.SetCompanyID(u)
	return ruo
}

// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (ruo *RoleUpdateOne) SetNillableCompanyID(u *uuid.UUID) *RoleUpdateOne {
	if u != nil {
		ruo.SetCompanyID(*u)
	}
	return ruo
...
// ClearCompanyID clears the value of the "company_id" field.
func (ruo *RoleUpdateOne) ClearCompanyID() *RoleUpdateOne {
	ruo.mutation.ClearCompanyID()
	return ruo
}
...
// SetCompany sets the "company" edge to the Company entity.
func (ruo *RoleUpdateOne) SetCompany(c *Company) *RoleUpdateOne {
...
// ClearCompany clears the "company" edge to the Company entity.
func (ruo *RoleUpdateOne) ClearCompany() *RoleUpdateOne {
