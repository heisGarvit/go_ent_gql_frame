...
func (pc *PermissionCreate) SetCompanyID(u uuid.UUID) *PermissionCreate {
	pc.mutation.SetCompanyID(u)
	return pc
}

// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableCompanyID(u *uuid.UUID) *PermissionCreate {
	if u != nil {
		pc.SetCompanyID(*u)
	}
	return pc
...
func (pc *PermissionCreate) SetWrite(b bool) *PermissionCreate {
	pc.mutation.SetWrite(b)
	return pc
}

// SetNillableWrite sets the "write" field if the given value is not nil.
func (pc *PermissionCreate) SetNillableWrite(b *bool) *PermissionCreate {
	if b != nil {
		pc.SetWrite(*b)
	}
	return pc
...
func (pc *PermissionCreate) SetPatch(b bool) *PermissionCreate {
	pc.mutation.SetPatch(b)
	return pc
}

// SetNillablePatch sets the "patch" field if the given value is not nil.
func (pc *PermissionCreate) SetNillablePatch(b *bool) *PermissionCreate {
	if b != nil {
		pc.SetPatch(*b)
	}
	return pc
...
func (pc *PermissionCreate) defaults() {
	...
	if _, ok := pc.mutation.Write(); !ok {
		v := permission.DefaultWrite
		pc.mutation.SetWrite(v)
	}
	if _, ok := pc.mutation.Patch(); !ok {
		v := permission.DefaultPatch
		pc.mutation.SetPatch(v)
	}
...
func (pc *PermissionCreate) check() error {
	...
	if _, ok := pc.mutation.Write(); !ok {
		return &ValidationError{Name: "write", err: errors.New(`ent: missing required field "Permission.write"`)}
	}
	if _, ok := pc.mutation.Patch(); !ok {
		return &ValidationError{Name: "patch", err: errors.New(`ent: missing required field "Permission.patch"`)}
	}
	if _, ok := pc.mutation.Delete(); !ok {
...
func (pc *PermissionCreate) createSpec() (*Permission, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.CompanyID(); ok {
	...
	if value, ok := pc.mutation.Write(); ok {
		_spec.SetField(permission.FieldWrite, field.TypeBool, value)
		_node.Write = value
	}
	if value, ok := pc.mutation.Patch(); ok {
