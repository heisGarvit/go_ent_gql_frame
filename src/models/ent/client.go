...
import (
	...
	"project/src/models/ent/migrate"
...
func (c *CompanyClient) QueryUsers(co *Company) *UserQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, company.UsersTable, company.UsersColumn),
		)
...
func (c *CompanyClient) QueryRoles(co *Company) *RoleQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, true, company.RolesTable, company.RolesColumn),
		)
		fromV = sqlgraph.Neighbors(co.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryCompany queries the company edge of a Role.
func (c *RoleClient) QueryCompany(r *Role) *CompanyQuery {
	...
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, false, role.CompanyTable, role.CompanyColumn),
		)
...
// QueryCompany queries the company edge of a RolePermission.
func (c *RolePermissionClient) QueryCompany(rp *RolePermission) *CompanyQuery {
	query := (&CompanyClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := rp.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		Company, Permission, Role, RolePermission, User []ent.Hook
	}
	inters struct {
		Company, Permission, Role, RolePermission, User []ent.Interceptor
	}
)
