...
func (uc *UserCreate) SetCompanyID(u uuid.UUID) *UserCreate {
	uc.mutation.SetCompanyID(u)
	return uc
}

// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (uc *UserCreate) SetNillableCompanyID(u *uuid.UUID) *UserCreate {
	if u != nil {
		uc.SetCompanyID(*u)
	}
	return uc
...
func (uc *UserCreate) SetDateOfBirth(efo *entFields.DateOnly) *UserCreate {
	uc.mutation.SetDateOfBirth(efo)
	return uc
}

// SetDateOfJoin sets the "date_of_join" field.
func (uc *UserCreate) SetDateOfJoin(efo *entFields.DateOnly) *UserCreate {
	uc.mutation.SetDateOfJoin(efo)
	return uc
}

// SetTimingStart sets the "timing_start" field.
func (uc *UserCreate) SetTimingStart(efo *entFields.TimeOnly) *UserCreate {
	uc.mutation.SetTimingStart(efo)
	return uc
}

// SetEmployeeID sets the "employee_id" field.
func (uc *UserCreate) SetEmployeeID(s string) *UserCreate {
	uc.mutation.SetEmployeeID(s)
	return uc
}

// SetNillableEmployeeID sets the "employee_id" field if the given value is not nil.
func (uc *UserCreate) SetNillableEmployeeID(s *string) *UserCreate {
	if s != nil {
		uc.SetEmployeeID(*s)
	}
	return uc
...
func (uc *UserCreate) SetNillableRoleID(u *uuid.UUID) *UserCreate {
	if u != nil {
		uc.SetRoleID(*u)
	}
	return uc
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.DateOfJoin(); !ok {
		return &ValidationError{Name: "date_of_join", err: errors.New(`ent: missing required field "User.date_of_join"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.DateOfJoin(); ok {
		_spec.SetField(user.FieldDateOfJoin, field.TypeOther, value)
		_node.DateOfJoin = value
	}
	if value, ok := uc.mutation.TimingStart(); ok {
		_spec.SetField(user.FieldTimingStart, field.TypeOther, value)
		_node.TimingStart = value
	}
	if value, ok := uc.mutation.EmployeeID(); ok {
