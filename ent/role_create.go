...
func (rc *RoleCreate) SetCompanyID(u uuid.UUID) *RoleCreate {
	rc.mutation.SetCompanyID(u)
	return rc
}

// SetNillableCompanyID sets the "company_id" field if the given value is not nil.
func (rc *RoleCreate) SetNillableCompanyID(u *uuid.UUID) *RoleCreate {
	if u != nil {
		rc.SetCompanyID(*u)
	}
	return rc
...
func (rc *RoleCreate) SetCompany(c *Company) *RoleCreate {
