...
var (
	...
	// UserOrderFieldDateOfBirth orders User by date_of_birth.
	UserOrderFieldDateOfBirth = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.DateOfBirth, nil
		},
		column: user.FieldDateOfBirth,
		toTerm: user.ByDateOfBirth,
		toCursor: func(u *User) Cursor {
			return Cursor{
				ID:    u.ID,
				Value: u.DateOfBirth,
	...
	// UserOrderFieldDateOfJoin orders User by date_of_join.
	UserOrderFieldDateOfJoin = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.DateOfJoin, nil
		},
		column: user.FieldDateOfJoin,
		toTerm: user.ByDateOfJoin,
		toCursor: func(u *User) Cursor {
			return Cursor{
				ID:    u.ID,
				Value: u.DateOfJoin,
	...
	// UserOrderFieldTimingStart orders User by timing_start.
	UserOrderFieldTimingStart = &UserOrderField{
		Value: func(u *User) (ent.Value, error) {
			return u.TimingStart, nil
		},
		column: user.FieldTimingStart,
		toTerm: user.ByTimingStart,
		toCursor: func(u *User) Cursor {
			return Cursor{
				ID:    u.ID,
				Value: u.TimingStart,
...
func (f UserOrderField) String() string {
	...
	case UserOrderFieldUpdatedAt.column:
		str = "updatedAt"
	case UserOrderFieldDateOfBirth.column:
		str = "dateOfBirth"
	case UserOrderFieldDateOfJoin.column:
		str = "dateOfJoin"
	case UserOrderFieldTimingStart.column:
		str = "timingStart"
	}
	return str
}
...
func (f *UserOrderField) UnmarshalGQL(v interface{}) error {
	...
	case "dateOfBirth":
		*f = *UserOrderFieldDateOfBirth
	case "dateOfJoin":
		*f = *UserOrderFieldDateOfJoin
	case "timingStart":
		*f = *UserOrderFieldTimingStart
	default:
