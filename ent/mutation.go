...
type UserMutation struct {
	...
	password       *string
	is_disabled    *bool
	date_of_birth  **entFields.DateOnly
	date_of_join   **entFields.DateOnly
	timing_start   **entFields.TimeOnly
	employee_id    *string
	role_id        *uuid.UUID
	clearedFields  map[string]struct{}
	company        *uuid.UUID
...
func (m *UserMutation) SetDateOfBirth(efo *entFields.DateOnly) {
	m.date_of_birth = &efo
}

// DateOfBirth returns the value of the "date_of_birth" field in the mutation.
func (m *UserMutation) DateOfBirth() (r *entFields.DateOnly, exists bool) {
	v := m.date_of_birth
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldDateOfBirth(ctx context.Context) (v *entFields.DateOnly, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) SetDateOfJoin(efo *entFields.DateOnly) {
	m.date_of_join = &efo
}

// DateOfJoin returns the value of the "date_of_join" field in the mutation.
func (m *UserMutation) DateOfJoin() (r *entFields.DateOnly, exists bool) {
	v := m.date_of_join
	if v == nil {
		return
	}
...
// OldDateOfJoin returns the old "date_of_join" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldDateOfJoin(ctx context.Context) (v *entFields.DateOnly, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDateOfJoin is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldDateOfJoin requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldDateOfJoin: %w", err)
	}
	return oldValue.DateOfJoin, nil
}

// ResetDateOfJoin resets all changes to the "date_of_join" field.
func (m *UserMutation) ResetDateOfJoin() {
	m.date_of_join = nil
}

// SetTimingStart sets the "timing_start" field.
func (m *UserMutation) SetTimingStart(efo *entFields.TimeOnly) {
	m.timing_start = &efo
}

// TimingStart returns the value of the "timing_start" field in the mutation.
func (m *UserMutation) TimingStart() (r *entFields.TimeOnly, exists bool) {
	v := m.timing_start
	if v == nil {
		return
	}
...
// OldTimingStart returns the old "timing_start" field's value of the User entity.
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldTimingStart(ctx context.Context) (v *entFields.TimeOnly, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldTimingStart is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldTimingStart requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldTimingStart: %w", err)
	}
	return oldValue.TimingStart, nil
}

// ClearTimingStart clears the value of the "timing_start" field.
func (m *UserMutation) ClearTimingStart() {
	m.timing_start = nil
	m.clearedFields[user.FieldTimingStart] = struct{}{}
}

// TimingStartCleared returns if the "timing_start" field was cleared in this mutation.
func (m *UserMutation) TimingStartCleared() bool {
	_, ok := m.clearedFields[user.FieldTimingStart]
	return ok
}

// ResetTimingStart resets all changes to the "timing_start" field.
func (m *UserMutation) ResetTimingStart() {
	m.timing_start = nil
	delete(m.clearedFields, user.FieldTimingStart)
}
...
func (m *UserMutation) Fields() []string {
	...
	if m.date_of_join != nil {
		fields = append(fields, user.FieldDateOfJoin)
	}
	if m.timing_start != nil {
		fields = append(fields, user.FieldTimingStart)
	}
...
func (m *UserMutation) Field(name string) (ent.Value, bool) {
	...
	case user.FieldDateOfJoin:
		return m.DateOfJoin()
	case user.FieldTimingStart:
...
func (m *UserMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	case user.FieldDateOfJoin:
		return m.OldDateOfJoin(ctx)
	case user.FieldTimingStart:
		return m.OldTimingStart(ctx)
	case user.FieldEmployeeID:
...
func (m *UserMutation) ClearedFields() []string {
	...
	if m.FieldCleared(user.FieldTimingStart) {
		fields = append(fields, user.FieldTimingStart)
	}
