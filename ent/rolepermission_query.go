...
func (rpq *RolePermissionQuery) QueryCompany() *CompanyQuery {
	query := (&CompanyClient{config: rpq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, false, rolepermission.CompanyTable, rolepermission.CompanyColumn),
		)
...
func (rpq *RolePermissionQuery) Clone() *RolePermissionQuery {
	...
	return &RolePermissionQuery{
		...
		withCompany:    rpq.withCompany.Clone(),
...
func (rpq *RolePermissionQuery) WithCompany(opts ...func(*CompanyQuery)) *RolePermissionQuery {
	query := (&CompanyClient{config: rpq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	rpq.withCompany = query
	return rpq
}
...
func (rpq *RolePermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*RolePermission, error) {
	...
	if query := rpq.withCompany; query != nil {
		if err := rpq.loadCompany(ctx, query, nodes, nil,
			func(n *RolePermission, e *Company) { n.Edges.Company = e }); err != nil {
			return nil, err
		}
	}
...
func (rpq *RolePermissionQuery) loadCompany(ctx context.Context, query *CompanyQuery, nodes []*RolePermission, init func(*RolePermission), assign func(*RolePermission, *Company)) error {
...
func (rpq *RolePermissionQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := rpq.ctx.Fields; len(fields) > 0 {
		...
		if rpq.withCompany != nil {
			_spec.Node.AddColumnOnce(rolepermission.FieldCompanyID)
		}
		if rpq.withRole != nil {
